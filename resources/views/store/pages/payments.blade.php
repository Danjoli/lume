<x-store.app-layout title="Formas de pagamento">
    ...
    <x-store.pages.hero eyebrow="Atendimento" title="Formas de pagamento" description="Confira as formas de pagamento disponíveis e escolha a melhor opção para finalizar sua compra." />
    ...
    <x-store.pages.cta title="Ficou com alguma dúvida?" description="Entre em contato com nossa equipe caso precise de ajuda com o pagamento do seu pedido." :href="route('store.pages.contact')" label="Entrar em contato" />
